import './style';
import { Component, render, h, sharpen } from '../../preact';

// initialize "Sharpen" first (async);
sharpen.init(BINARY_LOAD_PATH);
...
class App extends Component {
    ...
    handleClick () {
        // use "Sharpen" to get diff;
        console.log(sharpen.getInstance());
